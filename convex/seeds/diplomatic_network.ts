...
const TYPE_MAP: Record<string, OrganizationType> = {
  ...
  CONSULAT: OrganizationType.Consulate,
  CONSULAT_HONORAIRE: OrganizationType.HonoraryConsulate,
...
const DIPLOMATIC_NETWORK = [
  ...
  },
  {
    ...
    address: { city: "Madrid", street: "Calle Orense, 68, 2º Izda, 28020" },
    jurisdictionCountries: ["ES"],
