...
export function OrgSidebar({ isExpanded = false, onToggle }: OrgSidebarProps) {
  ...
  const navItems: NavItem[] = [
    ...
    {
      title: t("admin.nav.requests", "Demandes"),
      url: "/admin/requests",
      icon: FileText,
    },
    {
      title: t("admin.nav.consularRegistry", "Dossiers Consulaires"),
    ...
    {
      title: t("admin.nav.statistics", "Statistiques"),
      url: "/admin/statistics",
      icon: BarChart3,
    },
    {
      title: t("admin.nav.payments", "Paiements"),
      url: "/admin/payments",
      icon: CreditCard,
    },
    {
      title: t("admin.nav.posts", "Actualités"),
      url: "/admin/posts",
      icon: Newspaper,
    },
    {
      title: t("admin.nav.team", "Équipe"),
      url: "/admin/team",
      icon: Users,
    },
    {
      title: t("admin.nav.settings", "Paramètres"),
      url: "/admin/settings",
      icon: Settings2,
    },
  ];
