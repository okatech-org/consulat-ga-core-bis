...
import { MemberRole } from "@convex/lib/constants";
...
type OrgMemberRole = (typeof MemberRole)[keyof typeof MemberRole];
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					...
					<DialogDescription>
						{userName &&
							`${t("dashboard.dialogs.memberRole.descriptionPrefix")} ${userName}`}
					</DialogDescription>
				</DialogHeader>
					...
					<FieldGroup>
						<form.Field
							...
							children={(field) => (
								<Field>
									<FieldLabel>
										{t("dashboard.dialogs.memberRole.role")}
									</FieldLabel>
									<Select
