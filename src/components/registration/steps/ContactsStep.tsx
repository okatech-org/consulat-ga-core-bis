		...
		<div className="space-y-6">
									...
									return (
										...
										>
											...
											<p className="text-sm text-muted-foreground mt-1">
												{t(
													"profile.fields.countryOfResidenceDesc",
													"Utilisé pour déterminer les services consulaires disponibles",
												)}
											</p>
											{fieldState.invalid && (
												<FieldError id={errorId} errors={[fieldState.error]} />
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						{t(
							"profile.sections.emergencyContactsDesc",
				...
				<CardContent className="space-y-6">
					<EmergencyContactSection
						...
						title={t(
							"profile.sections.emergencyResidence",
							"Contact d'urgence (Pays de résidence)",
						)}
						sectionName="residence"
						t={t}
					/>
					...
					<EmergencyContactSection
						...
						title={t(
							"profile.sections.emergencyHomeland",
