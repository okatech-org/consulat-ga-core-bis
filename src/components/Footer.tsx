...
export function Footer() {
  ...
  const quickLinks = [
    ...
    {
      label: t("footer.links.civilStatus"),
      href: "/services?category=civil_status",
    },
    {
      label: t("footer.links.registration"),
      href: "/services?category=registration",
    },
    {
      label: t("footer.links.legalization"),
      href: "/services?category=legalization",
    },
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2 text-sm text-muted-foreground pt-4">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="tel:+33142996868" className="hover:text-primary">
                  +33 1 42 99 68 68
                </a>
              </p>
              <p className="flex items-center gap-2">
