...
export function CountrySelect(props: CountrySelectProps) {
	...
	const {
		...
		placeholder = t("common.country.placeholder", "Sélectionner un pays"),
		searchPlaceholder = t("common.country.search", "Rechercher..."),
		emptyText = t("common.country.empty", "Aucun pays trouvé"),
		disabledOptions = [],
		disabled = false,
		id,
	} = props;
