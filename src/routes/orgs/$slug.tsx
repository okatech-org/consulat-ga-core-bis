      ...
      <div className="min-h-screen bg-background flex flex-col">
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold mb-2">{t('orgs.notFound', 'Représentation non trouvée')}</h1>
                ...
                <CardContent className="space-y-3">
                  {org.phone && (
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`tel:${org.phone.replace(/\s/g, '')}`} className="text-primary hover:underline">
                        {org.phone}
                      </a>
                    </div>
                  )}
                  ...
                  {!org.phone && !org.email && !org.website && (
                    <p className="text-muted-foreground">{t('orgs.noContact', 'Aucune information de contact disponible.')}</p>
                  )}
                </CardContent>
              </Card>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t('orgs.servicesDesc', 'Consultez la liste des services consulaires disponibles.')}
                    </p>
                  </div>
                </div>
                <Button asChild>
