  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Nouvelle publication</h1>
          <p className="text-muted-foreground">Créer une actualité globale ou pour une organisation</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3">
          ...
          {isCommunique && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>PDF obligatoire pour les communiqués</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="border-2 border-dashed rounded-lg p-6 text-center">
                  ...
                  {documentName ? (
                    ...
                    <label htmlFor="document-upload" className="cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">Cliquez pour télécharger un PDF</p>
                    </label>
                  )}
                </div>
              </CardContent>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="border-2 border-dashed rounded-lg p-4 text-center">
                  ...
                  {coverImagePreview ? (
                    <div>
                      <img src={coverImagePreview} alt="Cover" className="w-full h-32 object-cover rounded mb-2" />
                      <Button
                        type="button"
                        variant="link"
                        size="sm"
          ...
          <Button type="submit" className="w-full" disabled={isSubmitting}>
            {isSubmitting ? "Enregistrement..." : publish ? "Publier" : "Enregistrer le brouillon"}
          </Button>
        </div>
      </form>
    </div>
