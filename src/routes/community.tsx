...
function CommunityPage() {
  ...
  // Fetch orgs for network sections
  ...
  // Filter companies and associations from orgs
  const companies = orgs?.filter((o) => o.type === "company").slice(0, 3);
  const associations = orgs
    ?.filter((o) => o.type === "association")
    .slice(0, 3);
