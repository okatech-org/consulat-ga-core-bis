...
function NewsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative h-[360px] md:h-[480px] overflow-hidden mb-8">
        <img
          src={actualitesHero}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            <Badge
              variant="secondary"
              className="mb-4 bg-white/20 text-white backdrop-blur-sm border-white/30"
            >
      ...
      {/* Filters */}
      <section className="sticky top-0 bg-background/50 backdrop-blur-sm z-10 py-2">
